...
{
    //ProductsController inherit the AdminController and its functionality 
    public class ProductsController : AdminController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price,ActiveFrom")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,ActiveFrom")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
