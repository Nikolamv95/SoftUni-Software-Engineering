...
namespace SUS.HTTP
{
    public class HttpServer : IHttpServer
    {
        ...
        public async Task StartAsync(int port)
        {
            ...
            while (true)
            {
                //Work with the client in this connection
        ...
        private async Task ProcessClientAsync(TcpClient tcpClient)
        {
            try
            {
                ...
                //Encoding.Utf8 -> Convert the data List<bytes> to string(text)
                ...
                response = route != null ? route.Action(request) : new HttpResponse("text/html", new byte[0], HttpStatusCode.NotFound);
